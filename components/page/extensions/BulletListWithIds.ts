// components/page/extensions/BulletListWithIds.ts
...
export const BulletListWithIds: BridgeExtension = CoreBridge.extendExtension({
  name: "bulletList",
    ...
    return {
      nodeId: {
        ...
        parseHTML: (el: HTMLElement): string | null =>
          el.tagName === "UL" ? el.getAttribute("data-node-id") : null,
        renderHTML: (attrs: {
          nodeId?: string | null;
